...
public class Ex01_Array {
	...
	//연관이 있는 같은 데이터 타입을 하나로 묶어놓은 그룹 이라고 생각하면 됨.
	//1차원 배열을 구성하는 요소 => 변수들(데이터들)
	
	//[1] [2] [3] [4]
	//2차원 배열 : 1차원 배열은 x축 (가로) 또는 y축(세로) 방향으로 행 도는 열만 있는 구조.
	...
	public static void main(String[] args) {
		...
		System.out.println("2차원배열의 크기 조회:" + array2.length); // 1차원 배열의 갯수
		...
		//2행 3열을 가진 2차우너 배열은 총 2x3인 6개의 데이터를 표현할 수 있음.
//		array2[0][0] = 1;
//		array2[0][1] = 2;
//		array2[0][2] = 3;
//		array2[1][0] = 4;
//		array2[1][1] = 5;
//		array2[1][2] = 6;
		//배열의 크기는 가변적으로 바뀔 수가 잇음 (2차원 배열부터)
